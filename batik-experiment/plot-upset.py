...
DEPS = [
    ('batik',               'batik/aot.map'),
    ('commons-io',          'batik-deps/commons-io/aot.map'),
    ('commons-logging',     'batik-deps/commons-logging-workload/aot.map'),
    ('xml-apis-ext',        'batik-deps/xml-apis-ext-workload/aot.map'),
    ('xml-apis',            'batik-deps/xml-apis-workload/aot.map'),
    ('xmlgraphics-commons', 'batik-deps/xmlgraphics-commons/aot.map'),
]
