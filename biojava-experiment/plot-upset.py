...
DEPS = [
    ('biojava-core',      'biojava/biojava-core/aot.map'),
    ('biojava-alignment', 'biojava/biojava-alignment/aot.map'),
    ('biojava-aa-prop',   'biojava/biojava-aa-prop/aot.map'),
    ('biojava-structure', 'biojava/biojava-structure/aot.map'),
    ('forester',          'biojava-deps/forester/aot.map'),
    ('commons-codec',     'biojava-deps/commons-codec/aot.map'),
    ('slf4j',             'biojava-deps/slf4j/slf4j-api/aot.map'),
]
