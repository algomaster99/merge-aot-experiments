...
Sets      = TreeCache + all 6 per-dep caches.
...
DEPS = [
    ('commons-configuration', 'commons-configuration/aot.map'),
    ('commons-lang3',         'commons-configuration-deps/commons-lang/aot.map'),
    ('commons-text',          'commons-configuration-deps/commons-text/aot.map'),
    ('commons-beanutils',     'commons-configuration-deps/commons-beanutils/aot.map'),
    ('commons-collections',   'commons-configuration-deps/commons-collections/aot.map'),
    ('commons-logging',       'commons-configuration-deps/commons-logging-workload/aot.map'),
]
