...
DEPS = [
    ('commons-compress',  'commons-compress/aot.map'),
    ('commons-io',        'commons-compress-deps/apache-commons-io/aot.map'),
    ('commons-codec',     'commons-compress-deps/commons-codec/aot.map'),
    ('commons-lang3',     'commons-compress-deps/commons-lang/aot.map'),
]
